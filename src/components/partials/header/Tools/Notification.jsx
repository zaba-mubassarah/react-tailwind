...
const notifyLabel = () => {
  return (
    <span className="relative lg:h-[32px] lg:w-[32px] text-[#FFFFFF] dark:text-white cursor-pointer rounded-full text-[20px] flex flex-col items-center justify-center">
...
const Notification = () => {
  return (
    <Dropdown classMenuItems="md:w-[300px] top-[48px]" label={notifyLabel()}>
