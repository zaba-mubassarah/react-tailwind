...
const messagelabel = () => {
  return (
    <span className="relative lg:h-[32px] lg:w-[32px] dark:text-white text-slate-900 cursor-pointer rounded-full text-[20px] flex flex-col items-center justify-center">
